<?php include("header.php")?>
    <div class="signup d-flex flex-column justify-content-center algin-items-center h-100">
        <form action="signupLogic.php" method="post" class='form-signin'>
            ...
            <button class='btn btn-lg btn-primary btn-block' type='sumbit' name='sumbit'>Sign Up</button>
